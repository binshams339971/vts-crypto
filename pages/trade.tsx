...
import refl from "../assets/images/vtsLogo.png";
                        ...
                        <div className="t-border-b t-border-gray-200 dark:border-gray-700">
                            <ul className="-mb-px t-flex t-flex-wrap t-text-center t-text-sm t-font-medium t-text-gray-500 dark:text-gray-400">
                                <li className="t-mr-2 hover:t-cursor-pointer">
                                    <a onClick={()=>activate("Buy")} className={`t-w-32 t-group t-inline-flex t-rounded-t-lg t-border-b-4 t-p-4 ${ active === "Buy" ? "t-border-[#2388E4] t-text-black" : "t-border-transparent hover:t-border-gray-300 hover:t-text-gray-600" }`}>
                                ...
                                <li className="t-mr-2 hover:t-cursor-pointer">
                                    <a onClick={()=>activate("Sell")} className={`t-w-32 t-group t-inline-flex t-rounded-t-lg t-border-b-4 t-p-4 ${ active === "Sell" ? "t-border-[#2388E4] t-text-black" : "t-border-transparent hover:t-border-gray-300 hover:t-text-gray-600" }`}>
